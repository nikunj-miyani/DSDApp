  ...
  return (
    <View className="flex-1 bg-white">
      ...
      <Header
        ...
        onPressRightSource={onPressSearch}
      />
      ...
      <View className="flex-1">
        ...
        <View className="flex-row items-center gap-3 py-5 px-6">
          <TouchableOpacity
            onPress={onPressMenu}
            className="w-[58px] h-[50px] items-center justify-center border rounded-lg border-blue100 border">
            <MainMenuIcon />
          </TouchableOpacity>
          <TouchableOpacity
          ...
          <CustomButton title="Load" containerStyle={{flex: 1}} />
        </View>
      </View>
